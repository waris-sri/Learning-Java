public class Classroom {
        public static void main(String[] args) {
                ...
                Students beam = new Students("Waris Sripatoomrak", "Saint Gabriel's College", "Mahidol University", 18,
                                1.78f);
                Students japan = new Students("Thanakrit Sriphiphattana", "Saint Gabriel's College",
                                "Chulalongkorn University",
                                18, 1.77f);
                Students nay = new Students("Phonlaphat Sitthadetwong", "Saint Gabriel's College", "Mahidol University",
                                17,
                                1.65f);
                Students aie = new Students("Thanet Reantongcome", "Saint Gabriel's College",
