...
class Japan {
  ...
  String school = "Saint Gabriel's College";
  String university = "King Mongkut's Institute of Technology Ladkrabang";
  int age = 18;
  float height = 1.77f;
}
...
class Nay {
  ...
  String school = "Saint Gabriel's College";
  String university = "Kasetsart University";
  int age = 17;
  float height = 1.65f;
}
...
class Aie {
  ...
  String school = "Saint Gabriel's College";
  String university = "Phramongkutklao College of Medicine";
  int age = 18;
  float height = 1.78f;
}
