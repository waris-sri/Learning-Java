...
public class App {
  ...
  public static void main(String[] args) throws Exception {
    ...
    transcript.setAudio_url(
      "https://raw.githubusercontent.com/johnmarty3/JavaAPITutorial/main/Thirsty.mp4"
    );
    ...
    HttpRequest getRequest = HttpRequest.newBuilder()
      // set the base API link
      .uri(
        new URI("https://api.assemblyai.com/v2/transcript" + transcript.getId())
      )
    ...
    while (true) {
      ...
      if (
        "completed".equals(transcript.getStatus()) ||
