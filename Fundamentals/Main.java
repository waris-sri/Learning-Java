...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        /* Formatting Numbers */
        NumberFormat currency = NumberFormat.getCurrencyInstance(); // no instantiating (allocating memory) here since
                                                                    // NumberFormat is an abstract class, so use the
                                                                    // factoring method (create a new object instead)
        ...
        try (Scanner scan = new Scanner(System.in)) {
            ...
            String userFullName = scan.nextLine().trim(); // to get the whole line of input, and to cut excess white
                                                          // spaces
        ...
        // if else if else
        System.out.println(
                (temperature > 30 ? "Hot" : (temperature > 20 ? "Beautiful" : "Freezing")) + " weather today!");
        ...
        switch (temperature) {
            ...
            case 30:
                ...
                break; // once a match is found, and the code block is executed, exit from the `switch`
        ...
        // Limitation: only can go forwards, so effects won't take place when edit
        // items; we can't iterate
