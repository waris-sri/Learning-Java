public class OverloadedConstructors {
    public static void main(String[] args) {
        // constructors with the same name, but different parameters, therefore
        // different constructor signatures
        // (constructor name + parameters = constructor signature)
        // this flexibility ensures objects can be created in multiple ways as per the
        // requirement, offering different functionalities

        OverloadedConstructors salad = new OverloadedConstructors("Cabbage", "Carrot", "Cherry Tomatoes", "Kelp",
                "Chicken", "Nuts", "Ranch Dressing");
    ...
    OverloadedConstructors(String vegetable1, String vegetable2, String vegetable3, String vegetable4, String protein1,
            String protein2, String dressing) {
