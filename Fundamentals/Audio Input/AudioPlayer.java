...
public class AudioPlayer {
        public static void main(String[] args)
                ...
                System.out.println(
                                "\033[1;38;5;210m" + "\n▚▚▚▚▚▚▚▚▚▚▚▚▚▚▚▚▚ Welcome to Java Jukebox! ▞▞▞▞▞▞▞▞▞▞▞▞▞▞▞▞▞▞"
                                                + "\033[0;0m");
                System.out.println(
                                "\033[0;38;5;245m" + "░░░░░░░░░░░░ We only have one song, deal with it ░░░░░░░░░░░░"
                                                + "\033[0;0m");

                // print song's file name
                System.out.println("\033[1;38;0m" + "\033[1;48;5;210m" + " ♫ Chosen Song " + "\033[0;0m"
                                + "\033[3;38;5;15m"
                ...
                while (!response.equals("Q")) {
                        ...
                        switch (response) {
                                case ("P"):
                                        ...
                                        System.out.println("\033[1;38;5;114m" + "\033[1;48;5;23m" + " ▶ Now Playing "
                                                        + "\033[0;0m"
                                                        + "\033[3;38;5;114m" + " " + file.getName() + "\033[0;0m");
                                        break;
                                case ("S"):
                                        clip.stop(); // r g b
                                        System.out.println("\033[1;38;5;222m" + "\033[1;48;2;105;75;0m"
                                                        + "   ❚❚ Paused   " + "\033[0;0m"
                                                        + "\033[3;38;5;222m" + " Song stopped." + "\033[0;0m");
                                        break;
                                case ("R"):
                                        clip.setMicrosecondPosition(0);
                                        System.out.println("\033[1;38;5;210m" + "\033[1;48;5;52m" + "    ⟲ Reset    "
                                                        + "\033[0;0m"
                                ...
                                case ("Q"):
                                        ...
                                        break;
                                default:
                                        System.out.println("\033[1;38;5;210m" + "\033[1;48;5;95m" + " Enter Control "
                                                        + "\033[0;38;5;15m"
