public class Operators {
    public static void main(String[] args) {
        // logical operators (&&, ||) are for boolean values, bitwise logical operators
        // are used with integers
        ...
        System.out.println("\n5 & 3 >> " + result1);
        int result2 = 8 | 29; /*
                               * 01000 OR (0's got overlapped by 1's)
                               * 11101
                               * → 11101 → 29
                               */
        System.out.println("8 | 29 >> " + result2);
        int result3 = 69 ^ 420; /*
                                 * 001000101 XOR (1 for unlike bits, 0 for like bits)
                                 * 110100100
                                 * → 111100001 → 481
                                 */
